...
for id in range(1,6):
    ...
    for s in ll:
        ...
        dd = ['颜值','L','动萌兔花束','心动萌兔套装女发型','子背带裤(男)','联赛无畏服(女)','WKC 气球','WKC 趣味眼镜','C助威头盔(女)','KLC助威头盔(女)','KLC助威头盔(男)','LC助威头盔(男)','C助威头盔(男)','二项循环炫光','月气球','青蛙头饰','FormulaC气球','FormulaE气球','瑗逮面饰','强红色喷漆','边太阳镜','博士紫色喷漆','浪漫枫情帽男)','-叶知秋眼镜','|雨伞头饰','祥云气球','万里挑气球','小小悟空的金箍棒','心相印发箍','音乐气球',
              '心动萌兔套装女服装','WkC头盔','凤气球','虎气球','娃黄色喷漆','一娃黄色喷漆','C娃黄色喷漆','^娃橙色喷漆','KC助威战服(女)','动萌兔气球','驻场D服装','氮气少少女装','KC助威头盔(男)','Formula C 气球','燃擎夏装(女)','鹿气球','小小恐龙气球','燃擎一夏发型男)','Ump气球','|F闺蜜眼镜','燃擎夏皇冠','瑞舞狮气球','船修理包']
        ...
        m = {1:{'〈':'(','〉':')','孑':'子','芾':'带','麇':'麋','圭':'主','曰':'日','居':'尾','爰':'爱','肘':'时','魃':'魅','酉':'西','免':'兔','泠':'冷','=':'三'},
             2:{'字航':'宇航','-夏':'一夏','2翼':'之翼','7星':'之星','自色':'白色','滨o':'滨DJ','场o':'场DJ','揭蛋':'捣蛋','萌鬼':'萌兔','告自':'告白','人7':'人Z','黑自':'黑白','末来':'未来','二角':'三角',
                '月镜':'目镜','-击':'一击','士著':'土著','@P':'CP','挑-':'挑一','自羊':'白羊','塞冰':'寒冰','战土':'战士','尺军':'R军','捐挥':'指挥','OJ':'DJ','萸雄':'英雄','精萸':'精英','萸灵':'英灵','自云':'白云','护日':'护目',
                '@博':'Q博','考虎':'老虎','显景':'显影','浪浸':'浪漫','自天':'白天','自虎':'白虎','-足':'十足','闺蝥':'闺蜜'}}
        ...
        for w in l:
            ...
            if o==1: # 单品
                if w.isdigit():
                    ...
                    ls = t[-1]
                    t = []
                    if ss in dd or ss=='气球' and w in [91,39,31,36,41] or ss=='天气球' and w in [81,44] or ss=='头饰' and w==91:
                        continue
